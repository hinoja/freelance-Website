 ...
 --}}
                    ...
                    <div class="form with-line">
                        ...
                        <div class="form-inside">
                            @if (old('url'))
                                @for ($i = 0; $i < count(array_filter(old('name_url'))); $i++)
                                    <div class="form boxed url-box">
                                        ...
                                        <input class="search-field" name="name_url[]" type="text"
                                            value="{{ old('name_url')[$i] }}" />
                                        <input class="search-field" name="url[]" type="url"
                                            value="{{ old('url')[$i] }}" />
                                    </div>
                                @endfor
                            @endif
                            ...
                            <div class="form boxed box-to-clone url-box">
                                ...
                                <input class="search-field" type="text" placeholder="Name" name="name_url[]"
                                    value="" />
                                <input class="search-field" type="url" placeholder="http://" name="url[]"
                                    value="" />
                            </div>

                            <a href="#" class="button gray add-url add-box"><i class="fa fa-plus-circle"></i> Add
                                URL</a>
                            <p class="note">Optionally provide links to any of your websites or social network profiles.
                            </p>
                        </div>
                    </div>
                    <!-- Experience  -->
                    <div class="form with-line">
                        ...
                        <div class="form-inside">
                            ...
                            @if (old('end_date'))
                                @for ($i = 0; $i < count(array_filter(old('company'))); $i++)
                                    <div class="form boxed experience-box">
                                        <a href="#" class="close-form remove-box button"><i
                                                class="fa fa-close"></i></a>
                                        <input class="search-field form-control" name="company[]" type="text"
                                            value="{{ old('company')[$i] }}" />
                                        <input class="search-field form-control" type="text" name="job_title[]"
                                            value="{{ old('job_title')[$i] }}" />
                                        <label for="start_date">Start Date</label>
                                        <input class="search-field form-control " name="start_date[]" type="date"
                                            value="{{ old('start_date')[$i] }}" /> <br>
                                        <label for="end_date"> End Date</label>
                                        <input class="search-field form-control " name="end_date[]" type="date"
                                            value="{{ old('end_date')[$i] }}" /> <br>
                                    </div>
                                @endfor
                            @endif
                            ...
                            <a href="#" class="button gray add-experience add-box"><i class="fa fa-plus-circle"></i>
                                Add Experience</a>
