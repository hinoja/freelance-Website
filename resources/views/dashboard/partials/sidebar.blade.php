        ...
        <ul class="metismenu " id="sidebarNav">
            ...
            <li class="active">
                ...
                <ul aria-expanded="false">
                    <li class="active"> <a href={{route('dashboardHome')}}>Default</a> </li>
                    <li> <a href={{route('eCommerce')}}>Ecommerce</a> </li>
                    <li> <a href={{route('carDealer')}}>Car Dealer</a> </li>
                    <li> <a href={{route('stockMarket')}}>Stock Market</a> </li>
                    <li> <a href={{route('dating')}}>Dating</a> </li>
                    <li> <a href={{route('jobPortal')}}>Job Portal</a> </li>
            ...
            <li><a href={{route('chat')}} aria-expanded="false"><i class="nav-icon ti ti-comment"></i><span class="nav-title">Chat</span></a> </li>
            <li><a class="has-arrow" href="javascript:void(0)" aria-expanded="false"><i class="nav-icon ti ti-calendar"></i><span class="nav-title">Calendar</span></a>
                <ul aria-expanded="false">
                    <li> <a href={{route('fullCalender')}}>Full Calendar</a> </li>
                    <li> <a href={{route('calenderList')}}>Calendar List</a> </li>
                </ul>
            </li>
            <li><a href={{route('mail')}} aria-expanded="false"><i class="nav-icon ti ti-email"></i><span class="nav-title">Mail</span></a> </li>
            <li>
            ...
            <li>
                ...
                <ul aria-expanded="false">
                    ...
                    <li> <a href='#'>Color Table </a> </li>
                    <li> <a href={{route('dataTable')}}>Data Table</a> </li>
                    <li> <a href={{route('editableTable')}}>Editable Table</a> </li>
                    <li> <a href={{route('exportTable')}}>Export Table</a> </li>
                </ul>
            </li>
            <li>
