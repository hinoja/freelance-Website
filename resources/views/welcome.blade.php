...
<div class="container">
	...
	<div class="one-third column">
		...
		<div class="recent-post">
			<div class="recent-post-img"><a href="blog-single-post.html"><img src="{{ asset('Assets/images/recent-post-01.jpg') }}" alt=""></a><div class="hover-icon"></div></div>
	...
	<div class="one-third column">
		...
		<!-- Post #2 -->
		<div class="recent-post">
			<div class="recent-post-img"><a href="blog-single-post.html"><img src="{{ asset('Assets/images/recent-post-02.jpg') }}" alt=""></a><div class="hover-icon"></div></div>
	...
	<div class="one-third column">
		...
		<!-- Post #3 -->
		<div class="recent-post">
			<div class="recent-post-img"><a href="blog-single-post.html"><img src="{{ asset('Assets/images/recent-post-03.jpg') }}" alt=""></a><div class="hover-icon"></div></div>
